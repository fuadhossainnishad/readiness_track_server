...
import {
  IRangeQualification,
  TQualificationLevel,
} from "./rangeQualification.interface";
...
const RangeQualification: Model<IRangeQualification> =
  model<IRangeQualification>("RangeQualification", RangeQualificationSchema);
